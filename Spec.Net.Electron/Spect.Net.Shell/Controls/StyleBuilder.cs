...
namespace Spect.Net.Shell.Controls
{
    public struct StyleBuilder
    {
        ...
        public StyleBuilder(string prop, string value) => _stringBuffer = _stringBuffer = $"{prop}:{value};";
        ...
        /// <param name="when">Condition in which the CSS Style is added.</param>
        /// <returns>StyleBuilder</returns>
        public StyleBuilder AddStyle(string prop, string value, Func<bool> when) => AddStyle(prop, value, when());
        ...
        /// <param name="when">Condition in which the CSS Style is added.</param>
        /// <returns>StyleBuilder</returns>
        public StyleBuilder AddStyle(StyleBuilder builder, bool when = true) => when ? AddValue(builder.Build()) : this;
        ...
        /// <returns>StyleBuilder</returns>
        public StyleBuilder AddStyle(StyleBuilder builder, Func<bool> when) => AddStyle(builder, when());
